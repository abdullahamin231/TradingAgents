...
export const portfolioTotalEquityInput = document.querySelector("#portfolio-total-equity");
export const portfolioCashNotionalInput = document.querySelector("#portfolio-cash-notional");
export const portfolioMaxPositionsInput = document.querySelector("#portfolio-max-positions");
...
export const portfolioApplyPlanButton = document.querySelector("#portfolio-apply-plan");
